...
<div class="hs-hero">
  <div>
    <h1 class="hs-hero__headline">构建生产级智能体，<br><span class="hs-hero__accent">而非原型。</span></h1>
    ...
    <div class="hs-hero__actions">
      <a href="quickstart/installation.html" class="hs-btn hs-btn--primary">快速开始 →</a>
    ...
    <div class="hs-window">
      <div class="hs-window__bar">
        ...
        <div class="hs-window__tabs">
          <div class="hs-tab active" data-panel="zh-react">基础 Agent</div>
          <div class="hs-tab" data-panel="zh-harness">Harness Agent</div>
        </div>
      </div>
      <div class="hs-code-panel" id="zh-react"><pre><span class="kw">import</span> io.agentscope.core.*;
...
agent.call(messages).block();</pre></div>
      <div class="hs-code-panel" id="zh-harness" style="display:none"><pre><span class="kw">import</span> io.agentscope.harness.*;
...
<span class="cm">// 主 Agent 同步 / 异步委派</span>
<span class="ty">String</span> report = agent
    .delegate(<span class="str">"researcher"</span>, <span class="str">"分析竞品"</span>)
    .block();
agent.delegateAsync(<span class="str">"coder"</span>, <span class="str">"实现功能"</span>)
    ...
    <div class="hs-split__text">
      ...
      <a href="task/multi-agent.html" class="hs-btn hs-btn--secondary" style="margin-top:4px">了解多智能体 →</a>
    </div>
  </div>
</div>
