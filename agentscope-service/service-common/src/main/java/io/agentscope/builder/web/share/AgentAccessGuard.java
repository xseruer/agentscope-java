 ...
 *
 * <p>Visibility resolution is delegated to the plane-local {@link AgentVisibilityResolver}
 * (catalog service in the control plane, a JPA read view in the data plane) so this guard stays
 * usable from both planes without a cross-plane Maven dependency.
 */
@Service
public class AgentAccessGuard {

    private final AgentVisibilityResolver visibilityResolver;
    private final AgentAclService acl;

    public AgentAccessGuard(AgentVisibilityResolver visibilityResolver, AgentAclService acl) {
